def create_deck() -> list:
    """
    Create a deck of cards not including jokers.

    :postcondition: creates a deck of cards as a list not including jokers.
    :return: a list of dictionaries for each card in a deck not including jokers
    ...
    {'name': 'Jack', 'suite': 'Spades', 'value': 10}, {'name': 'Jack', 'suite': 'Clubs', 'value': 10},
    {'name': 'Jack', 'suite': 'Diamonds', 'value': 10}, {'name': 'Jack', 'suite': 'Hearts', 'value': 10},
    {'name': 'Queen', 'suite': 'Spades', 'value': 10}, {'name': 'Queen', 'suite': 'Clubs', 'value': 10},
    {'name': 'Queen', 'suite': 'Diamonds', 'value': 10}, {'name': 'Queen', 'suite': 'Hearts', 'value': 10},
    {'name': 'King', 'suite': 'Spades', 'value': 10}, {'name': 'King', 'suite': 'Clubs', 'value': 10},
    {'name': 'King', 'suite': 'Diamonds', 'value': 10}, {'name': 'King', 'suite': 'Hearts', 'value': 10}]
    """
