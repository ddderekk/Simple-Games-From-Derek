...
class TestCreateDeckWar(TestCase):
    def test_create_deck_war(self):
        expected_result = [{'name': 'Ace', 'suite': 'Spades', 'value': 1},
                           ...
                           {'name': 'Jack', 'suite': 'Spades', 'value': 11},
                           {'name': 'Jack', 'suite': 'Clubs', 'value': 11},
                           {'name': 'Jack', 'suite': 'Diamonds', 'value': 11},
                           {'name': 'Jack', 'suite': 'Hearts', 'value': 11},
                           {'name': 'Queen', 'suite': 'Spades', 'value': 12},
                           {'name': 'Queen', 'suite': 'Clubs', 'value': 12},
                           {'name': 'Queen', 'suite': 'Diamonds', 'value': 12},
                           {'name': 'Queen', 'suite': 'Hearts', 'value': 12},
                           {'name': 'King', 'suite': 'Spades', 'value': 13},
                           {'name': 'King', 'suite': 'Clubs', 'value': 13},
                           {'name': 'King', 'suite': 'Diamonds', 'value': 13},
                           {'name': 'King', 'suite': 'Hearts', 'value': 13}]
        actual_result = create_deck_war()
